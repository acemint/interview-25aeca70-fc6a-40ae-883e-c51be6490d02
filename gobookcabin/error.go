...
// Application error codes, referenced from (https://github.com/benbjohnson/wtf).
//
...
// ErrCodeInternal error and the human user should only see "Internal error" as the
...
func (e *Error) Error() string {
	return fmt.Sprintf("gobookcabin app error: code=%s message=%s", e.Code, e.Message)
}

// ErrorCode unwraps an application error and returns its code.
// Non-application errors always return ErrCodeInternal.
